...
<template>
    <Popover class="relative bg-white">
        <div class="flex items-center justify-between p-6 md:justify-start md:space-x-10">
            ...
            <div class="-my-2 -mr-10 md:hidden">
                <PopoverButton
            ...
            <div class="hidden md:flex md:flex-1 md:items-center md:justify-between">
                                    ...
                                    <div class="bg-gray-50 p-5 sm:p-8">
                                        <a href="#" class="-m-3 flow-root rounded-md p-3 hover:bg-gray-100">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="ml-3 inline-flex items-center rounded-full bg-indigo-100 px-3 py-0.5 text-xs font-medium leading-5 text-indigo-800">New</span>
                                            </div>
                                            <p class="mt-1 text-sm text-gray-500">Empower your entire team with even
                                                more advanced tools.</p>
                                        </a>
                                    </div>
                                </div>
                            </PopoverPanel>
                ...
                <div class="flex items-center md:ml-12">
                    ...
                    <a href="#"
                        class="ml-8 inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Sign
                        up</a>
                </div>
            </div>
        </div>
